...
import './NumberCountingSectionAi.css';
    ...
    if (isChecked) {
      ...
      try {
        ...
        if (i18n.language.toLowerCase() === 'fr') {
          fileUrl = 'https://drive.google.com/file/d/1wizH6FEO0oaJBBOJpK4x-wnJARk9q8SR/view?usp=drive_link';
        } else {
          fileUrl = 'https://drive.google.com/file/d/1eP9CadtoXXRoiZavRBhO6fN83ixawzFy/view?usp=drive_link';
        }
    ...
    <>
      <div className="number-counting-section" ref={countingRef}>
        <div className="counting-item" data-aos="zoom-in-up" data-aos-duration="1000">
          ...
          <div>
            <p>{t('NumberCountingSectionAi.counting-item1')}</p>
            <p>{t('NumberCountingSectionAi.counting-item2')}</p>
          </div>
        </div>
        <div className="counting-item" data-aos="zoom-in-up" data-aos-duration="1000">
