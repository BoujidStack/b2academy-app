...
import { saveFormDatab2academyAiConsultingProgram } from '../firebase/FirebaseUtils';
import Swal from 'sweetalert2';
import PropTypes from 'prop-types';

function ModalOverlayEnrollAIConsultingProgram({ onClose }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (
                ...
                await saveFormDatab2academyAiConsultingProgram(formData);
        ...
        <div className="modal-overlay">
            <div className="modal-content" data-aos="zoom-in-up" data-aos-duration="1000">
                <div className="modal-header">
                    <h2>{t('ModalOverlayEnrollAIConsultingProgram.title')}</h2>
...
// Define PropTypes
ModalOverlayEnrollAIConsultingProgram.propTypes = {
    onClose: PropTypes.func.isRequired, // onClose should be a function and is required
};
export default ModalOverlayEnrollAIConsultingProgram;
