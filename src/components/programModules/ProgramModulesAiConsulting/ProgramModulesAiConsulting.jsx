...
import './ProgramModulesAiConsulting.css';
...
const ProgramModulesAiConsulting = () => {
  ...
  return (
    <div name="ProgramModulesAiConsulting" className="ProgramModulesAiConsulting">
      <div data-aos="fade-down" data-aos-duration="1000"><img src={planet1} alt="planet1" width={300} height={300} className="ProgramModulesAiConsultingImage" /></div>
      <div data-aos="fade-left" data-aos-duration="1000"><img src={planet2} alt="planet2" width={700} height={700} className="ProgramModulesAiConsultingImageRight" /></div>
      <img src={lignes} alt="lignes" width={2000} height={1000} className="ProgramModulesAiConsultinglignes" data-aos="zoom-in" data-aos-duration="1000" />
      ...
      <div className='ProgramModulesAiConsultingcontentModules' data-aos="zoom-in" data-aos-duration="1000">
        <h1>{t('ProgramModulesAiConsulting.module1')}</h1>
        <p>{t('ProgramModulesAiConsulting.module1-description')}</p>
      </div>

      <div className='ProgramModulesAiConsultingcontentModulesTwo' data-aos="zoom-in" data-aos-duration="1000">
        <h1>{t('ProgramModulesAiConsulting.module2')}</h1>
        <p>{t('ProgramModulesAiConsulting.module2-description')}</p>
      </div>

      <div className='ProgramModulesAiConsultingcontentModulesThree' data-aos="zoom-in" data-aos-duration="1000">
        <h1>{t('ProgramModulesAiConsulting.module3')}</h1>
        <p>{t('ProgramModulesAiConsulting.module3-description')}</p>
      </div>

      <div className='ProgramModulesAiConsultingcontentModulesFourth' data-aos="zoom-in" data-aos-duration="1000">
        <h1>{t('ProgramModulesAiConsulting.module4')}</h1>
        <p>{t('ProgramModulesAiConsulting.module4-description')}</p>
      </div>

      <div className='ProgramModulesAiConsultingcontentModulesFive' data-aos="zoom-in" data-aos-duration="1000">
        <h1>{t('ProgramModulesAiConsulting.module5')}</h1>
        <p>{t('ProgramModulesAiConsulting.module5-description')}</p>
      </div>
    </div>
  );
};
