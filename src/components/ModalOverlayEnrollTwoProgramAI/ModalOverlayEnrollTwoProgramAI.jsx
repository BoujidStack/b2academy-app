...
import { saveFormDatab2academyTwoProgrammAI } from '../firebase/FirebaseUtils';
import Swal from 'sweetalert2';
import PropTypes from 'prop-types';

function ModalOverlayEnrollTwoProgramAI({ onClose }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (
                ...
                await saveFormDatab2academyTwoProgrammAI(formData);
        ...
        <div className="modal-overlay">
            <div className="modal-content" data-aos="zoom-in-up" data-aos-duration="1000">
                <div className="modal-header">
                    <h2>{t('ModalOverlayEnrollTwoProgrammAI.title')}</h2>
                    <p>{t('ModalOverlayEnrollTwoProgrammAI.description')}</p>
                    <br /><br />
...
// Define PropTypes
ModalOverlayEnrollTwoProgramAI.propTypes = {
    onClose: PropTypes.func.isRequired, // onClose should be a function and is required
};

export default ModalOverlayEnrollTwoProgramAI;
